...
const About = () => {
  return (
    <div>
      <div className="container py-5 my-5 text-start">
                <div className="row">
                    ...
                    <div className="col-md-6 d-flex justify-content-center">
                        <img src="https://openshop.uz/public/storage/uploads/products/photos/202210/arHME9JUx27hqlZdgkKTjwDnqCkWVZhMgry9qf0O.jpg" alt="About Us" height="400px" width="400px" />
                    </div>
                </div>
            </div>
    </div>
